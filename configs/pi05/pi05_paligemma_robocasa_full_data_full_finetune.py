...
# q01/q99 quantile normalization shared with eval. When no explicit statistics
# are supplied below, train.py computes them from these exact training roots.
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # If dataset_statistics or dataset_statistics_path is supplied, it
        # takes priority. Otherwise train.py computes transformed state/action
        # statistics once on rank 0 before dataset construction.
        auto_compute_statistics=dict(profile='robocasa-joint-delta'),
        datasets=dict(
            type='ParquetDataset',
