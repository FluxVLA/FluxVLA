...
_PI05_LIBERO_10_STATS = {
    'libero_10_no_noops': {
        ...
        'action': {
            'mean': [
                0.016879137986109773, 0.05853519754616345,
                -0.057178108485074444, 0.004843023152202687,
                0.0026568295055006816, -0.006974684365701462,
                0.5382604794507188
            ],
            'std': [
                0.28125830890626635, 0.360486859565329, 0.3704184954939684,
                0.038201435574751884, 0.05424184276304238, 0.08876161093891541,
                0.498533986516695
            ],
            'min': [
            ...
            'q01': [
                -0.6187499761581421, -0.7767857313156128, -0.7607142925262451,
                -0.09857142716646194, -0.14785714447498322,
                -0.2742857038974762, 0.0
            ],
            'q99': [
                0.7741071581840515, 0.8464285731315613, 0.9375,
                0.14249999821186066, 0.15857142210006714, 0.33642858266830444,
                1.0
            ],
            'count':
            1025340
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset_statistics=_PI05_LIBERO_10_STATS,
        name_mappings={
