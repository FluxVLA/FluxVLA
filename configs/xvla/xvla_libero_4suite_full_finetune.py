...
_XVLA_LIBERO_IMAGE_MEAN = [123.675, 116.28, 103.53]
_XVLA_LIBERO_IMAGE_STD = [58.395, 57.12, 57.375]


def _xvla_libero_transforms():
    return [
        dict(
        ...
        dict(
            ...
            means=[_XVLA_LIBERO_IMAGE_MEAN.copy() for _ in range(3)],
            stds=[_XVLA_LIBERO_IMAGE_STD.copy() for _ in range(3)],
        ),
    ]


def _xvla_libero_dataset(data_root_path):
    return dict(
        type='ParquetDataset',
        data_root_path=data_root_path,
        transforms=_xvla_libero_transforms(),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[
            _xvla_libero_dataset(f'{_LEROBOT_ROOT}/libero_10_lerobotv2.1'),
            _xvla_libero_dataset(f'{_LEROBOT_ROOT}/libero_goal_lerobotv2.1'),
            _xvla_libero_dataset(f'{_LEROBOT_ROOT}/libero_object_lerobotv2.1'),
            _xvla_libero_dataset(
                f'{_LEROBOT_ROOT}/libero_spatial_lerobotv2.1'),
        ],
    ),
)
