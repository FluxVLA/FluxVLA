# Example ARM config: CLIP ViT-B/32 + ALOHA-style dataset.
#
# - Backbone: CLIP (`./checkpoints/clip-vit-base-patch32`)
# - Camera: `observation.images.cam_high`
# - State: `observation.state` (32-dim padded)
# - Dataset: LeRobot v3 smoke path (override via --cfg-options)
#
...
current_collator = dict(
    ...
    keys=[
        ...
        'progress', 'interval_targets', 'text_input_ids', 'text_attention_mask'
    ],
