...
DiT4DiT の結果は commit `5aa9288838aad86a19245c2797de96a2bcfb789d`、設定
`configs/dit4dit/dit4dit_libero_all_full_finetune.py`、checkpoint
`step-120000-epoch-147-loss=0.0439.safetensors` に対応します。
