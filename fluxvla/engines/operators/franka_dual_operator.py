...
class FrankaDualOperator(BaseOperator):
    ...
    def __init__(
            ...
            gripper_goal_right_topic=None,
            gripper_action_left_name=None,  # kept for config compatibility
            gripper_action_right_name=None,  # kept for config compatibility
            gripper_speed=1.0,
        ...
        self.joint_cmd_left_topic = (
            ...
            f'{self.left_arm_ns}/joint_ruckig_smooth_position_controller/target_joint_state'  # noqa: E501
        )
        self.joint_cmd_right_topic = (
            joint_cmd_right_topic or
            f'{self.right_arm_ns}/joint_ruckig_smooth_position_controller/target_joint_state'  # noqa: E501
        )
        ...
        self.gripper_goal_left_topic = self._resolve_gripper_goal_topic(
            ...
            gripper_action_left_name,
            f'{self.left_arm_ns}/franka_gripper/move/goal')
        self.gripper_goal_right_topic = self._resolve_gripper_goal_topic(
            gripper_right_topic or gripper_goal_right_topic,
            gripper_action_right_name,
            f'{self.right_arm_ns}/franka_gripper/move/goal')
